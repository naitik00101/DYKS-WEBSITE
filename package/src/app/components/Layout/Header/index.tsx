  ...
  return (
    <header
      className={`fixed top-0 z-40 py-4 w-full transition-all duration-300 ${
        sticky ? 'shadow-md bg-[#FAF6F0]/90 backdrop-blur-md' : 'shadow-none'
      }`}>
      <div>
        ...
        <div
          ref={mobileMenuRef}
          className={`lg:hidden fixed top-0 right-0 h-full w-full bg-[#FAF6F0] shadow-lg transform transition-transform duration-300 max-w-xs ${
